...
Transformar o "HoraProfe" em um produto por assinatura.
...
- [ ] (Opcional/Avançado) Verificar via Webhook ou Metadata se a assinatura está ativa. _Para a primeira versão, podemos confiar no fluxo de "pagou -> liberou" ou verificar manualmente, mas o ideal é conectar o Stripe ao Clerk._
